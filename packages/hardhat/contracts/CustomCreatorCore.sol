...
import "./interfaces/ICustomCreatorCore.sol";

/**
 * @dev Core creator implementation
 */
abstract contract CustomCreatorCore is ReentrancyGuard, ICustomCreatorCore, ERC165 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165) returns (bool) {
        return interfaceId == type(ICustomCreatorCore).interfaceId || super.supportsInterface(interfaceId)
