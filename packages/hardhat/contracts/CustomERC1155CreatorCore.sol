...
import "./interfaces/ICustomERC1155CreatorCore.sol";
import "./CustomCreatorCore.sol";

/**
 * @dev Core ERC1155 creator implementation
 */
abstract contract CustomERC1155CreatorCore is CustomCreatorCore, ICustomERC1155CreatorCore {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(CustomCreatorCore, IERC165) returns (bool) {
        return interfaceId == type(ICustomERC1155CreatorCore).interfaceId || super.supportsInterface(interfaceId);
    }
